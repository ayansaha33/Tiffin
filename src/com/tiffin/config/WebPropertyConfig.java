 ...
 */
@Configuration
@PropertySources({@PropertySource(value = "classpath:application.properties", ignoreResourceNotFound = false), @PropertySource(value = "classpath:message.properties", ignoreResourceNotFound = false)})
public class WebPropertyConfig {

    private static final Logger LOGGER = LoggerFactory.getLogger(WebPropertyConfig.class);
